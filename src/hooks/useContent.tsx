...
export const useContent = () => {
  ...
  return [
    ...
    />,
    <p key={2}>
      <b>{t("Please follow these steps to reset geolocation permission")}</b>
    </p>,
    <p key={4}>
    ...
    <p key={6}>
      <b>3.-</b> When you close the permissions modal window, a bar appears with
      a reload button, click on it.
    </p>,
    <p key={7}>
